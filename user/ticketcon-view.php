                              ...
                              <div class="col-sm-12">
                                  <div class="row">
                                      ...
                                      <div class="col-sm-8">
                                          ...
                                          <br>
                                          <div class="row">
                                              <div class="col-sm-6"><strong>Atención:</strong> <?php echo $lsT['atencion_usuario']; ?></div>
                                              <div class="col-sm-6"><strong>Problema:</strong> <?php echo $lsT['mensaje']; ?></div>
                                          </div>
                                          <br>
                                          <div class="row">
                                              <div class="col-sm-6"><strong>Fecha de Atenion:</strong> <?php echo $lsT['fecha_atencion']; ?></div>
                                              <div class="col-sm-6"><strong>Solución:</strong> <?php echo $lsT['solucion']; ?></div>
                                          </div>
                                      </div>
                                  </div>
                              </div>
