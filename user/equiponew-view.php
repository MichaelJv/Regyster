                ...
                <div class="panel-body">
                  <div class="row">
                    <div class="col-sm-4 text-center">
                      <br><br><br>
                      <img src="img/soporte_ticket.png" alt=""><br><br>
                            ...
                            <div class='col-sm-10'>
                                ...
                                window.onload = function(){
                                  ...
                                  if(mes<10)
                                    ...
                                    document.getElementById('fechainput').value=dia+"/"+mes+"/"+ano;
                                }
                                </script>
                                    <input class="form-control" type="text" id="fechainput" placeholder="Fecha" name="fecha_ticket" required="" readonly value="">
