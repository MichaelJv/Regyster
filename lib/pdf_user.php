...
$pdf->Cell (0,5,utf8_decode('HSJDP Perú'),0,1,'C');
...
$pdf->Cell (35,10,'Atención',1,0,'C',true);
$pdf->Cell (0,10,utf8_decode($reg['atencion_usuario']),1,1,'L');
