<?php if($_SESSION['nombre']!="" && $_SESSION['tipo']=="admin"){ ?>    
        ...
        <div class="container">
          <div class="row">
            <div class="col-sm-2">
                <img src="./img/trabajando.png" alt="Image" class="img-responsive animated flipInY">
            </div>
            <div class="col-sm-10">
              <p class="lead text-info">Bienvenido administrador, en esta página se muestran todos los administradores registrados en HELPDESK HSJDP, usted podra eliminarlos si lo desea.</p>
            </div>
          </div>
        </div>
