    ...
    <div class="container-fluid">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="index.php">
                <img src="img/minsa.png" alt="Logo del Ministerio de Salud"
                width="170"  height="30"/>
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            ...
            <li>
                ...
                <li>
                    <a href="./index.php?view=equipos"><span class="fa fa-desktop"></span>&nbsp;&nbsp;Equipos</a>
                </li>
                <?php endif ?>
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li>
                            <a href="./index.php?view=mensaje">
                            <span class="glyphicon glyphicon-comment"></span>
                            &nbsp;&nbsp;Mensajes
                            <?php
                            $nombre=$_SESSION['nombre_completo'];
                            $num_ticket_us=Mysql::consulta("SELECT * FROM ticket WHERE nombre_usuario='$nombre' AND estado_mensaje='1'");
                        ...
                        <?php if($_SESSION['tipo']=="admin"): ?>
                        <li>
                            <a href="admin.php?view=equipoadmin"><span class="glyphicon glyphicon-print"></span> &nbsp; Administrar Equipos</a>
                        </li>
                        <li>
                        ...
                        <li>
                            <a href="admin.php?view=admin"><span class="fa fa-id-card"></span> &nbsp;Administrar Administradores</a>
                        </li>
                        <li>
    ...
    <div class="modal-dialog modal-sm">
      <div class="modal-content">
            <div class="modal-header">
              ...
              <h4 class="modal-title text-center text-primary" id="myModalLabel">Bienvenido a HELPDESK HSJDP</h4>
            </div>
